export default class threeScene {
    ...
    moveCamera(index, oldIndex) {
        ...
        if (index <= 11) {
            ...
            this.enlargeTween(this.textButton, { x: 0.025, y: 0.025, z: -0.025 })
        ...
        this.movementTimeline = gsap.timeline({
            onComplete: () => {
                ...
                if (target.id <= 11) {
                    ...
                    this.showCirclesCircle(false)
                    this.enlargeTween(this.textBG, { x: 0.01, y: 0.01, z: -0.01 })
                    this.enlargeTween(this.textButton, { x: 0.01, y: 0.01, z: -0.01 })
                    ...
                    this.enlargeTween(this.textBG, { x: 0.025, y: 0.025, z: -0.025 })
                    this.enlargeTween(this.textButton, { x: 0.025, y: 0.025, z: -0.025 })
